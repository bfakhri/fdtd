...
for i in range(1000000):
    ...
    grid.visualize(z=0, norm='log', animate=True, objcolor=(0, 0, 0, 0), objedgecolor=(1,1,1,0), plot_both_fields=False, save=True, folder='./sim_frames_enlight_world6/', index=i, clean_img=True)
